            ...
            children: [
              TableCalendar(
                ...
                onDaySelected: (selectedDay, focusedDay) async {
                  ...
                  debugPrint('_selYear DSel: ${_selectedDay.year.toString()}');
                  debugPrint('selYear DSel: ${selectedDay.year.toString()}');
                  debugPrint(isSameYear.toString());
                ...
                onPageChanged: (focusedDay) async {
                  debugPrint('_selYear PgCh: ${_selectedDay.year.toString()}');
                  debugPrint('_focYear PgCh: ${_focusedDay.year.toString()}');
                  debugPrint('focYear PgCh: ${focusedDay.year.toString()}');
